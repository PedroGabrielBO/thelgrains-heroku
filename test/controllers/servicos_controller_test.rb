...
class ServicosControllerTest < ActionController::TestCase
  ...
  test "should create servico" do
    assert_difference('Servico.count') do
      post :create, servico: { nome: @servico.nome, taxa_ajudante: @servico.taxa_ajudante, taxa_principal: @servico.taxa_principal, valor: @servico.valor }
    end
  ...
  test "should update servico" do
    patch :update, id: @servico, servico: { nome: @servico.nome, taxa_ajudante: @servico.taxa_ajudante, taxa_principal: @servico.taxa_principal, valor: @servico.valor }
    assert_redirected_to servico_path(assigns(:servico))
  end
